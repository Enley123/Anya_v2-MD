...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "the futur billionnaire",
    ownernumber: process.env.Owner_Number || "50934251716",
    ...
    sessionId: process.env.SESSION_ID || "eGhxajM_Queen-Anya_3M_Queen-Anya_2M_Queen-Anya_=",
